...
interface PauseLogSearchProps {
  items: PauseLogItem[];
  onFilteredItemsChange: (filteredItems: PauseLogItem[]) => void;
}
...
export const PauseLogSearch: React.FC<PauseLogSearchProps> = ({ items, onFilteredItemsChange }) => {
  ...
  const { emotions, tags, statuses, itemTypes, maxPrice } = useMemo(() => {
  ...
  const filteredItems = useMemo(() => {
    let filtered = items.filter(item => {
      ...
      // Cart filter
      if (filters.isCart === 'cart' && !item.is_cart) return false;
      if (filters.isCart === 'item' && item.is_cart) return false;
        ...
        <div className="flex items-center gap-2">
          <Select value={filters.sortBy} onValueChange={(value) => setFilters(prev => ({ ...prev, sortBy: value }))}>
            ...
            <SelectContent>
              ...
              <SelectItem value="store_name">Store</SelectItem>
        ...
        <CollapsibleContent className="space-y-4 border rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <Select value={filters.isCart} onValueChange={(value) => setFilters(prev => ({ ...prev, isCart: value }))}>
                <SelectTrigger>
                  <SelectValue placeholder="All types" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="">All types</SelectItem>
                  <SelectItem value="item">Single Items</SelectItem>
                  <SelectItem value="cart">Shopping Carts</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
