...
const AddPauseButton = ({ onAddPause }: AddPauseButtonProps) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="relative w-full text-foreground font-medium py-24 sm:py-12 px-6 transition-all duration-200 overflow-hidden transform hover:scale-[1.02] active:scale-[0.98]"
      style={{ 
