...
const PauseHeader = ({ onProfileModalChange }: PauseHeaderProps = {}) => {
  ...
  return (
    <>
      <header className="relative mb-8 sm:mb-12 max-w-sm md:max-w-lg lg:max-w-2xl mx-auto">
        ...
        <div className={`absolute ${installed ? 'top-6 sm:top-8' : 'top-12 sm:top-16'} right-4 sm:right-6 flex items-center justify-end gap-3`}>
          {showCourses && (
            <button
