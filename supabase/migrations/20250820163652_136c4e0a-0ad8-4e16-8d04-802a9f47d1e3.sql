...
-- Add timezone and email tracking fields to user_settings
ALTER TABLE public.user_settings 
ADD COLUMN IF NOT EXISTS timezone TEXT DEFAULT 'UTC',
ADD COLUMN IF NOT EXISTS last_reminder_sent DATE DEFAULT NULL;

-- Update default notification time to 7 PM
ALTER TABLE public.user_settings 
ALTER COLUMN notification_time_preference SET DEFAULT '19:00:00'::time without time zone;

-- Create function to send timezone-aware review reminders
  ...
  LOOP
    ...
    IF user_local_hour = EXTRACT(HOUR FROM COALESCE(user_record.notification_time_preference, '19:00:00'::TIME)) THEN
      ...
      PERFORM net.http_post(
        ...
        body := json_build_object('user_id', user_record.user_id)::jsonb
      );
...
SELECT cron.schedule(
  ...
  'SELECT public.send_timezone_aware_reminders();'
);